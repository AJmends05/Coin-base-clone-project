...
import { PORTFOLIO_ROWS } from "../../data/constants";
    ...
    return (
        <div className="cb-phone-mockup">
            ...
            <div className="cb-phone-body">
                <div className="cb-balance-amount">$28,503.86</div>
                <div className="cb-balance-change">↗ $382.14 (1.36%) 1D ›</div>
                ...
                <div className="cb-phone-tabs">
                    {["1H", "1D", "1W", "1M", "1Y", "All"].map((t) => (
                        <button key={t} className={`cb-phone-tab${activeTab === t ? " active" : ""}`} onClick={() => onTabClick(t)}>{t}</button>
                    ))}
                </div>
